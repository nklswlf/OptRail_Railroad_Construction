...
neighboorhood_types = ['Replace_Shift_Worker', 'Replace_Shift_Machine', 'Replace_Shift_Attachment', 'Swap_Shift_Worker', 'Swap_Shift_Machine', 'Swap_Shift_Attachment', 'Swap_Shift_External', 'Insert_Shift']
neighboorhood_types = ['Insert_Shift']



def run_simulated_annealing(instance_filename = "Construction_a10_o107_m5_an57_ar12.json", order_item_attractiveness_technique="balanced_greedy", machine_attractiveness_technique="balanced_greedy"):
    ...
    simulated_annealing = SimulatedAnnealingLocalSearch(data, start_temp=100,
                                                        min_temp = 1, cooling_rate=0.999,
                                                        max_iterations=10,
